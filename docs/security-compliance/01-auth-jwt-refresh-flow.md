---
title: "[Arşiv] Spring Security Authentication Flow with JWT and Refresh Token"
description: "[Arşiv] Auth flow eski sürümü. Güncel sayfa: 04 · Authentication & Authorization → Stateful Token Model."
