---
title: "[Eski] TanStack Query — RTK Query'nin yerini aldı"
description: Bu sayfa artık geçersiz. Lumix server state için RTK Query kullanıyor — bkz. "RTK Query" sayfası.
