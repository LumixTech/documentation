---
title: "[Arşiv] Hexagonal Validation Separation (Adapter vs Core)"
description: "[Arşiv] Hexagonal mimari validation ayrımının eski sürümü. Güncel sayfa: 02 · Mimari Patterns → Hexagonal Architecture."
