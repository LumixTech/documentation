---
title: "[Arşiv] Spring WebSocket and STOMP — RabbitMQ Broker Relay (ESKİ)"
description: "[Arşiv] WebSocket fan-out için RabbitMQ broker relay öneren eski sürüm. Lumix bu kararı değiştirdi: Redis Pub/Sub backplane."
